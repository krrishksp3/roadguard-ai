...
async function main() {
  ...
  > = {
    pothole: {
      ...
      mimeType: 'image/jpeg',
      title: 'Water-filled Pothole Cavity on Asphalt Road',
    ...
    pothole_alt: {
      ...
      mimeType: 'image/jpeg',
      title: 'Multiple Severe Road Cavities & Potholes Cluster',
      sourceUrl: 'UPLOADED_REFERENCE_EVIDENCE',
      license: 'LICENSED_REFERENCE',
      author: 'Contributed Photo Evidence',
      originalLocation: 'Reference Road Dataset',
    ...
    waterlogging: {
      ...
      mimeType: 'image/jpeg',
      title: 'Urban Road Waterlogging & Storm Puddle Inundation',
      sourceUrl: 'UPLOADED_REFERENCE_EVIDENCE',
      license: 'LICENSED_REFERENCE',
      author: 'Contributed Photo Evidence',
      originalLocation: 'Reference Road Dataset',
    ...
    drainage_damage: {
      ...
      filename: 'waterlogging-reference.jpg',
      mimeType: 'image/jpeg',
      title: 'Urban Road Drainage & Water Puddles',
      sourceUrl: 'UPLOADED_REFERENCE_EVIDENCE',
      license: 'LICENSED_REFERENCE',
      author: 'Contributed Photo Evidence',
      originalLocation: 'Reference Road Dataset',
    ...
    crack: {
      ...
      mimeType: 'image/jpeg',
      title: 'Pavement Shear Rupture & Deep Surface Fracture',
      sourceUrl: 'UPLOADED_REFERENCE_EVIDENCE',
      license: 'LICENSED_REFERENCE',
      author: 'Contributed Photo Evidence',
      originalLocation: 'Reference Road Dataset',
    ...
    surface_deterioration: {
      ...
      mimeType: 'image/jpeg',
      title: 'Damaged Asphalt & Coarse Surface Deterioration',
      sourceUrl: 'UPLOADED_REFERENCE_EVIDENCE',
      license: 'LICENSED_REFERENCE',
      author: 'Contributed Photo Evidence',
      originalLocation: 'Reference Road Dataset',
    ...
    road_edge_damage: {
      ...
      filename: 'road-edge-reference.jpg',
      mimeType: 'image/jpeg',
      title: 'Broken Pavement Edge & Shoulder Subsidence',
      sourceUrl: 'UPLOADED_REFERENCE_EVIDENCE',
      license: 'LICENSED_REFERENCE',
      author: 'Contributed Photo Evidence',
      originalLocation: 'Reference Road Dataset',
    ...
    signage_damage: {
      ...
      filename: 'severe-damage-reference.jpg',
      mimeType: 'image/jpeg',
      title: 'Multiple Road Defects & Surface Deterioration',
      sourceUrl: 'UPLOADED_REFERENCE_EVIDENCE',
      license: 'LICENSED_REFERENCE',
      author: 'Contributed Photo Evidence',
      originalLocation: 'Reference Road Dataset',
